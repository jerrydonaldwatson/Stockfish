...
#undef S
  ...
  Score Evaluation<T>::threats() const {
    ...
    Bitboard levers = (pos.pieces(Us, PAWN) & attackedBy[Them][PAWN]) | (pos.pieces(Them, PAWN) & attackedBy[Us][PAWN]);
    b = ((pos.pieces(Us) ^ pos.pieces(Us, PAWN, KING)) | levers) & attackedBy[Us][ALL_PIECES];
