...
Score Entry::do_king_safety(const Position& pos, Square ksq) {
  ...
  if (pos.can_castle(MakeCastling<Us, KING_SIDE>::right))
      bonus = std::max(bonus, shelter_storm<Us>(pos, relative_square(Us, SQ_G1)) - Value(8));

  if (pos.can_castle(MakeCastling<Us, QUEEN_SIDE>::right))
  {
      Value castleBonus = std::max(shelter_storm<Us>(pos, relative_square(Us, SQ_C1)) - Value(8), shelter_storm<Us>(pos, relative_square(Us, SQ_B1)) - Value(16));
      bonus = std::max(bonus, castleBonus);
  }
